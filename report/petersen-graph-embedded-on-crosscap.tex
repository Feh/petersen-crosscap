...
\enlargethispage{1cm}%
You can view an online version of the rendered video here:
\url{http://feh.userpage.fu-berlin.de/petersen.html}

\begin{figure}[t]
  \caption{The camera motion and a rendered image}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{screenshots/construction07.png}
    \caption{A global view of the camera moving around the object. The
      rectangle at the bottom is used to view the texture of the cross
      cap in the plain.}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{screenshots/construction08.jpg}
    \caption{A screenshot from the resulting video. We use the
      Maya’s raytracing mode in order to get realistic-looking shadows
...
We introduced first the Petersen graph and then the cross cap; we then
showed how the graph can be embedded on
